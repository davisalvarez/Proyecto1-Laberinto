...
int main()                                    // main 
{
  while(turn == 1){                         //llop para que siempre se mantenga en movimiento
    drive_rampStep(115,115);                //instruccion que permite que el robot se mantenga a una velocidad constante
      ...
      while(ping_cm(8) < 33){               //advertencia del sensor,un objeto a menos de 35cm
        ...
        drive_speed(-60,-60);                         //retrocede por unn momento
        pause(250);
